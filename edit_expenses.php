...
<section class="main-container shadow-lg">
  <div style="padding: 5%;">
    ...
    <div>
      ...
      <h4 style="margin-top: 25px;">Edit Expense</h4>

      <form method="post" action="<?= BASE_PATH ?>/edit_expenses.php?id=<?=(int)$expense['id']; ?>" style="margin-top: 10px;">
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-3">
            ...
            <select class="form-control" name="budget_id" aria-label="optional budget select" >
